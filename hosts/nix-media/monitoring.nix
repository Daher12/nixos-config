...
in
{
  ...
  services.prometheus = {
    ...
    globalConfig = {
      ...
      external_labels = { monitor = "nix-media"; environment = "production"; };
    };
  ...
  services.prometheus.alertmanager = {
    ...
    configuration = {
      ...
      route = {
        ...
        repeat_interval = "4h";
        routes = [
          { match = { severity = "critical"; }; receiver = "ntfy"; repeat_interval = "1h"; }
        ];
      };
      receivers = [{
        name = "ntfy";
  ...
  systemd.services.prometheus.serviceConfig = {
    MemoryMax = "512M"; MemoryHigh = "384M"; CPUQuota = "50%";
    CPUWeight = 100; IOWeight = 100; TasksMax = 512; Nice = 10;
  };
  systemd.services.prometheus-node-exporter.serviceConfig = {
    MemoryMax = "128M"; MemoryHigh = "96M"; CPUQuota = "20%";
    CPUWeight = 50; TasksMax = 64; Nice = 15;
  };
  systemd.services.alertmanager.serviceConfig = {
    MemoryMax = "128M"; CPUQuota = "10%"; Nice = 10;
  };
  ...
  systemd.services.intel-gpu-metrics = {
    ...
    serviceConfig = {
      ...
      TimeoutStartSec = "8s"; MemoryMax = "32M"; CPUQuota = "10%"; Nice = 19;
  ...
  systemd.services.grafana.serviceConfig = {
    MemoryMax = "384M"; MemoryHigh = "320M"; CPUQuota = "30%";
    CPUWeight = 100; TasksMax = 256; Nice = 5;
  };
  ...
  environment.etc."grafana/dashboards/system-overview.json".text = builtins.toJSON {
    ...
    panels = [
      ...
      {
        id = 3; gridPos = { x = 0; y = 8; w = 12; h = 8; };
        type = "timeseries"; title = "Storage Usage";
      ...
      {
        id = 4; gridPos = { x = 12; y = 8; w = 12; h = 8; };
        type = "timeseries"; title = "Network Traffic";
        targets = [
      ...
      {
        id = 5; gridPos = { x = 0; y = 16; w = 12; h = 8; };
      ...
      {
        id = 6; gridPos = { x = 12; y = 16; w = 12; h = 8; };
      ...
      {
        id = 8; gridPos = { x = 0; y = 24; w = 12; h = 8; };
        type = "timeseries"; title = "Intel GPU (N100)";
        targets = [
      ...
      {
        id = 7; gridPos = { x = 12; y = 24; w = 12; h = 8; };
