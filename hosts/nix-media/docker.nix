...
in
{
  ...
  # --- Pre-requisites: Network & Directories ---
  ...
  virtualisation.oci-containers.containers = {
    ...
    jellyfin = {
      autoStart = true;
      image = "lscr.io/linuxserver/jellyfin:latest"; # [NOTE] Pinned 'latest' for auto-updates
      environment = {
  ...
  # --- Resource Prioritization (Systemd) ---
  ...
  systemd.services."docker-cadvisor" = {
    serviceConfig = {
      CPUWeight = 50;
      OOMScoreAdjust = 700; # Kill first
    };
  };

  # --- Auto-Update Timer (The "Drift") ---
